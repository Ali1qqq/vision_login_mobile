...
AlertDialog buildSignViewDialog(
    {required String text,
    required EmployeeModel account,
...
AlertDialog buildSignImageView(String image, void Function() onPressed, String salaryId) {
  return AlertDialog(
    backgroundColor: secondaryColor,
    actions: [
      GetBuilder<SalaryViewModel>(builder: (controller) {
          ...
          children: [
            Container(
              ...
              child: Column(children: [
                ...
                if (!checkIfPendingDelete(affectedId: salaryId)) AppButton(text: "تراجع", onPressed: onPressed)
              ]),
            ),
          ],
        );
